...
require_once('../Controlador/ctrNovedad.php');
...
<div id="slidingbar-area">
								...
								<ul class="sub-menu">
									<li>
										<a href="form_elements.html">
											<span class="title">Registrar Persona</span>
										</a>
									</li>
									<li>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
								  <div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i> REGISTRAR NOVEDAD</h2>
										<p>
											En esta sección usted podrá registrar una solicitud de Cambio o de Devolucion
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrNovedad.php?action=registrar">
        <div class="row">
												
		<div class="col-md-6">
	   <div class="form-group">
													<label class="control-label">
															Tipo de Novedad <span class="symbol required"></span>
    </label>
 ...
 <div class="form-group">
						...
						<input type="text" placeholder="Ingrese la Descripcion" class="form-control" id="descripcion" name="descripcion">
 </div>
   </div>
   <div class="form-group">
													<label class="control-label">
															Excedente <span class="symbol required"></span>
 </label>
                                                      <input type="text" placeholder="Ingrese el Execedente del Repuesto" class="form-control" id="excedente" name="excedente">
								
 </div>
 <div class="form-group">
														<label class="control-label">
															Reembolso <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Ingrese el Reembolso del Repuesto" class="form-control" id="apellidos" name="apellidos">
</div>
   </div>
   <div class="col-md-6">
													<div class="form-group connected-group">
...
<div class="col-md-3">
						  <input type="text" placeholder="YYYY" id="fechaNovedad" name="fechaNovedad" class="form-control">
														  </div>	
                                                            <div class="col-md-3">
															  <select name="fechaNovedad" id="fechaNovedad" class="form-control" >
													...
													<div class="form-group">
														<label class="control-label">
															Repuesto Entrante<span class="symbol required"></span>
														</label>
														<?php echo ctrRepuesto::getList("idRepuesto"); ?>
	</div>
													<div class="form-group">
														<label class="control-label">
															Repuesto Saliente <span class="symbol required"></span>
														</label>
														<?php echo ctrRepuesto::getList("idRepuesto"); ?>
</div>
<div class="form-group">
														<label class="control-label">
															Venta <span class="symbol required"></span>
														</label>
														<?php echo ctrPersona::getList("idPersona"); ?>
</div>
...
<div id="showContributors">
			...
			<!-- end: SUBVIEW SAMPLE CONTENTS --><!-- start: MAIN JAVASCRIPTS -->
		<!--[if lt IE 9]>
