						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
								  <div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i> REGISTRAR UNIDAD MEDIDA</h2>
										<p>
											Bienvenido al Taller de Tecnimotos por favor Ingrese sus datos
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrUnidadMedida.php?action=registrar">
        <div class="row">
												
		<div class="col-md-8">
		  <div class="form-group">
														<label class="control-label">Nombre<span class="symbol required">
														<input type="text" placeholder="Ingrese el nombre" class="form-control" id="nombre" name="nombre">
														</span>
					  </label>
 </div>
 
<div class="form-group">Descripcion
  <input type="Ingrese la descripcion" placeholder="Ingrese la descripcion" class="form-control" id="descripcion" name="descripcion">
								
 </div>
 
 <div class="form-group">
														<label class="control-label">Tipo<span class="symbol required">
													    <input type="text" placeholder="Ingrese el tipo" class="form-control" id="tipo" name="tipo">
														</span>
					  </label>
 </div>
		</div>
