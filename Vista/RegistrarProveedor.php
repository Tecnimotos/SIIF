<?php   
require_once('../Controlador/ctrProveedor.php');
...
<html lang="en">
	...
	<body>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<h2><i class="fa fa-pencil-square"></i> Registrar Proveedor</h2>
										<p>
											
										</p>
										<hr>
								       <form name="form1" method="post" id="form1" action="../Controlador/ctrProveedor.php?action=registrar">
											<div class="row">
												<div class="col-md-12">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															Tipo Proveedor <span class="symbol required"></span>
   												      </label>
        ...
        <option value="Informal">Informal</option>
													...
													<div class="form-group">
														<label class="control-label">
															Razon Social <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Insert your Last Name" class="form-control" id="razonSocial" name="razonSocial">
													</div>
													<div class="form-group">
														<label class="control-label">
															Nit <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Text Field" class="form-control" id="nit" name="nit">
													</div>
													<div class="form-group">
														<label class="control-label">
													...
													<div class="form-group">
														...
														<input type="direccion" class="form-control" id="direccio" name="direccion">
												</div>
													...
													<div class="form-group">
														<label class="control-label">
															Contacto <span class="symbol required"></span>
                                                        														...
                                                        														<input type="contacto" class="form-control" id="contacto" name="contacto">
												</div>
                                                    
                                                    
<div class="form-group">
														<label class="control-label">
															Telefono Contacto <span class="symbol required"></span>
														</label>

														<input type="telefonoContacto" class="form-control" id="telefonoContacto" name="telefonoContacto"><div>
