					  ...
					  <div class="row">
							<div class="col-md-6 col-lg-4 col-sm-7">
								<div class="panel panel-default panel-white core-box">
									...
									<div class="panel-body no-padding">
										<div class="partition-blue padding-20 text-center core-icon"><img width="60" height="60" alt="" class="img-circle pull-left" src="assets/images/repuestos.jpg"></div>
									  <div class="padding-20 core-content">
									    <h3 class="title block no-margin">REPUESTOS</h3>
                                        <span class="subtitle"> Tecnimotos cuenta con un stock permanente de repuestos, para cada uno de los equipos importados por nuestra empresa. Asimismo disponemos de repuestos genéricos. </span>
										</div>
								...
								<div class="panel panel-default panel-white core-box">
									...
									<div class="panel-body no-padding">
										<div class="partition-blue padding-20 text-center core-icon">
											<img width="60" height="60" alt="" class="img-circle pull-left" src="assets/images/proveedores.jpg">
										</div>
										<div class="padding-20 core-content">
                                        
											<h3 class="title block no-margin">PROVEEDORES</h3>
											<span class="subtitle"> La relación entre proveedores y Tecnimotos es importante para establecer el cumplimiento de los objetivos y entregarle al cliente un producto o servicio de calidad que satisfaga sus necesidades. </span>
										</div>
									</div>
									<div class="panel-footer clearfix no-padding"></div>
								</div>
							</div>
						<div class="col-md-6 col-lg-4 col-sm-7">
								<div class="panel panel-default panel-white core-box">
									...
									<div class="panel-body no-padding">
										<div class="partition-blue padding-20 text-center core-icon">
								        <img width="60" height="60" alt="" class="img-circle pull-left" src="assets/images/novedad.jpg"> </span></div>
										<div class="padding-20 core-content">
											<h3 class="title block no-margin">NOVEDADES</h3>
											<span class="subtitle"> Se aceptan Cambios y Devolucion en nuestros Productos  </span>
										</div>
									</div>
									<div class="panel-footer clearfix no-padding"></div>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-5">
								<div class="panel panel-red panel-calendar">
									<div class="panel-heading border-light">
										<h4 class="panel-title">Fecha Actual</h4>
										<div class="panel-tools">
											<div class="dropdown">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-12">
								<div class="panel panel-white">
									<div class="panel-heading border-light">
										<h4 class="panel-title">Usuarios de Tecnimotos</h4>
										<div class="panel-tools">
											<div class="dropdown">
												<a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
													<i class="fa fa-cog"></i>
									...
									<div class="panel-body no-padding">
										<div class="padding-10">
											...
											<h4 class="no-margin inline-block padding-5">Administrador <span class="block text-small text-left">UI Designer</span></h4>
