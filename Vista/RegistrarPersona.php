						...
						<div class="toolbar row">
							<div class="col-sm-6 hidden-xs">
								<div class="page-header">
									<h1>Formulario de Registro <small></small></h1>
								</div>
							</div>
 ...
 <div class="form-group">
	...
	<div class="col-md-12">
													<div class="form-group">
														<label class="control-label">
														Email </label>
														<input type="email" placeholder="Ingrese su correo" class="form-control" id="email" name="email">
										  </div>
                 ...
                 <div id ="form2">                    
													<div class="form-group">
													  <label class="control-label">
														...
														<input type="text" placeholder="ingrese su usuario" class="form-control" id="usuario" name="usuario">
					</div>	
