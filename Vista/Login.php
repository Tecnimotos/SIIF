		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<form name = "form" method = "post" id = "form" action="../Controlador/ctrPersona.php?action=login" class="form-login" >
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" name="contrasena" id ="contrasena" placeholder="Password">
