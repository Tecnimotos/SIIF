	...
	<body>
						...
						<div class="row">
							<div class="col-md-12">
								<ol class="breadcrumb">
									...
									<li class="active">Tipo de Repuesto</li>
								</ol>
							</div>
						</div>
						<!-- end: BREADCRUMB -->
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
								  <div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i> REGISTRAR TIPO DE REPUESTO</h2>
										<p>En esta sección usted podrá registrar los Tipo de Repuestos que se encuentran en Tecnimotos
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrTipoRepuesto.php?action=registrar">
        <div class="row">
		...
		<div class="col-md-6">
		  <div class="form-group">
														...
														<input type="text" placeholder="Ingrese el Nombre de Tipo de Repuesto" class="form-control" id="nombre" name="nombre">
 </div>
...
<div class="form-group">
													<label class="control-label">
                                                      ...
                                                      <input type="Ingrese la descripcion del tipo de repuesto" placeholder="Ingrese sus Nombres" class="form-control" id="descripcion" name="descripcion">
