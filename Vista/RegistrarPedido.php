						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
								  <div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i> REGISTRAR PEDIDO</h2>
										<p>
											Bienvenido al Taller de Tecnimotos por favor Ingrese sus datos
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrPedido.php?action=registrar">
        <div class="row">
												
		<div class="col-md-6">
		  <div class="form-group">Fecha
		    <input type="text" placeholder="Ingrese Fecha" class="form-control" id="fecha" name="fecha">
 </div>
 
<div class="form-group">Referencia
  <input type="Ingrese Referencia" placeholder="Ingrese Referencia" class="form-control" id="referencia" name="referencia">
								
 </div>
 Proveedor
<div class="form-group connected-group">
   <?php echo ctrProveedor::getList("idProveedor"); ?> 
