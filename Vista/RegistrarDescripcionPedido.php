<?php require_once('../Controlador/ctrRepuesto.php'); ?>
<?php require_once('../Controlador/ctrPedido.php'); ?>
<!DOCTYPE html>
...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="assets/pluge="apple-mobile-web-app-capable" content="yes">
		<meta name="apple-mobile-web-app-status-bar-style" content="black">
		<meta content="" name="description" />
		<meta content="" name="author" />
		<!-- end: META -->
		<!-- start: MAIN CSS -->
		<link href='http://fonts.googleapis.com/css?family=Raleway:400,300,500,600,700,200,100,800' rel='stylesheet' type='text/css'>ins/font-awesome/css/font-awesome.min.css">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i>DESCRIPCIÓN DEL PEDIDO</h2>
																		<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrDescripcionPedido.php?action=registrar">
											<div class="row">
												...
												<div class="col-md-6">
												  <div class="form-group">
													<p>
													  ...
													  <input type="text" placeholder="ingrese la cantidad" class="form-control" id="cantidad" name="cantidad">
													</p>
												  </div>
 <div class="form-group">
														<label class="control-label">Porcentaje<span class="symbol required"></span>
														</label>
					  <input type="text" placeholder="ingrese el porcentaje" class="form-control" id="porcentaje" name="porcentaje">
 </div>
												  <div class="form-group">
													<label class="control-label">Ubicación</label>
                                                      <input type="text" placeholder="Ingrese la ubicacion" class="form-control" id="ubicacion" name="ubicacion">
								
												  </div>
													<div class="form-group">
														<label class="control-label">Valor Unitario <span class="symbol required"></span>
														</label>
														<input type="Ingrese sus Apellidos" placeholder="Ingrese sus Apellidos" class="form-control" id="valorUnitario" name="valorUnitario">
													</div>
													<div class="form-group">
													  <label class="control-label">Repuesto<span class="symbol required"></span>:
														</label>
														<td><?php echo ctrRepuesto::getList("idRepuesto"); ?></td
														>
													</div>
													<div class="form-group">
													  <label class="control-label">
															Pedido: <span class="symbol required"></span>
														</label>
														<td><?php echo ctrPedido::getList("idPedido"); ?></td>
													</div>
												</div>
												<div class="col-md-6">
										  <div class="row">
													  ...
													  <label class="control-label">
															Estado <span class="symbol required"><span class="form-group">
