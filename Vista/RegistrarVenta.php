							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<h2><i class="fa fa-pencil-square"></i> REGISTAR VENTA</h2>
										<p>
											Create one account to manage everything you do with Rapido, from your shopping preferences to your Rapido activity.
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrVenta.php?action=registrar">
											<div class="row">
											  <div class="col-md-12">
												...
												<div class="col-md-6">
												  <div class="form-group">Fecha Venta:
													<input type="datetime" name="fechaVenta" id="fechaVenta">
													</div>
													<div class="form-group">
														<label class="control-label">Descripcion<span class="symbol required">:<br>
															</span>
													  </label>
														<input type="text" placeholder="Insert your Last Name" class="form-control" id="descripcion" name="descripcion">
													</div>
													<div class="form-group">
														<label class="control-label">
															Referencia: <span class="symbol required"></span>
														</label>
														<input class="form-control tooltips" type="text" data-original-title="We'll display it when you write reviews" data-rel="tooltip"  title="" data-placement="top" name="referencia" id="referencia">
													</div>
                                                    
                                                    <div class="form-group">
                                                     Vendedores:
                                                   <?php echo ctrEmpleado::getList("idEmpleado"); ?>
