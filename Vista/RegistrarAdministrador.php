...
<html lang="en">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i> REGISTRAR</h2>
										<p>
											Bienvenido al Taller de Tecnimotos por favor Ingrese sus datos
										</p>
										<hr>
										<form name="form1" method="post" id="form1" action="../Controlador/ctrEmpleado.php?action=registrar">
											<div class="row">
												
												<div class="col-md-6">
												  <div class="form-group">
													<label class="control-label">
															Tipo e Usuario <span class="symbol required"></span>
												    </label>
 ...
 <div class="form-group">
														<label class="control-label">
														Identificacion <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Ingrese su Numero de Documento" class="form-control" id="identificacion" name="identificacion">
												  </div>
												  <div class="form-group">
													<label class="control-label">
															Nombres <span class="symbol required"></span>
												    </label>
                                                      <input type="Ingrese sus Nombres" placeholder="Ingrese sus Nombres" class="form-control" id="nombres" name="nombres">
													...
													<div class="form-group">
														...
														<input type="Ingrese sus Apellidos" placeholder="Ingrese sus Apellidos" class="form-control" id="apellidos" name="apellidos">
													</div>
													<div class="form-group">
														<label class="control-label">
															Direccion <span class="symbol required"></span>
														</label>
														<input type="direccion" placeholder="Ingrese su Direccion" class="form-control" name="direccion" id="direccion">
													</div>
													<div class="form-group">
														<label class="control-label">
															Telefono <span class="symbol required"></span>
														</label>
														<input type="telefono" placeholder="Ingrese su Numero de Celular" class="form-control" id="telefono" name="telefono">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group connected-group">
														<label class="control-label">
															Email <span class="symbol required"></span>
																...
																<input type="text" placeholder="Ingrese su Email" class="form-control" id="email" name="email">
																</span>
													...
													<div class="form-group connected-group">
														<label class="control-label  ">
															Usuario <span class="symbol required"></span>
																...
																<input type="text" placeholder="Ingrese su Tipo de Usuario" class="form-control" id="usuario" name="usuario">
													...
													<div class="form-group connected-group">
														<label class="control-label">
															Estado <span class="symbol required"></span>
																...
																<input type="text"  size="32" class="form-control" name="estado" id="estado">
						</div>
