...
<?php require_once('../Controlador/ctrventa.php'); ?>
<!DOCTYPE html>
...
<html lang="en">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">								    <h2><i class="fa fa-pencil-square"></i>DESCRIPCIÓN VENTA</h2>
																		<hr>
 ...
 <div class="form-group">
					  ...
					  <input type="text" placeholder="ingrese el porcentaje" class="form-control" id="valorVenta" name="valorVenta">
 </div>
												  <div class="form-group">
													<label class="control-label">Descripción</label>
													<input type="Ingrese la ubicación" placeholder="Ingrese sus Nombres" class="form-control" id="descripcion" name="descripcion">
								
												  </div>
													<div class="form-group">
														<label class="control-label">Valor Total</label>
														<input type="Ingrese sus Apellidos" placeholder="Ingrese el valor total" class="form-control" id="valorTotal" name="valorTotal">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
													  <label class="control-label">Venta: <span class="symbol required"></span>
														</label>
														<td><?php echo ctrVenta::getList("idVenta"); ?></td>
													</div>
												</div>
												<div class="col-md-6">
										  <div class="row">
