...
abstract class Conexion {
	...
	private $dbname = "Tecnimotos";
	
	abstract protected static function buscarForId($id);
	abstract protected static function buscarAll();
	abstract protected static function buscar($campo, $valor);
    abstract protected function inactivar($id);
	//abstract protected function login ($usuario,$contrasena);
	...
	//Getting row
	//$getrow = $database->getRow("SELECT email, username FROM users WHERE username =? AND nombre = ?", array("das","Diego"));
